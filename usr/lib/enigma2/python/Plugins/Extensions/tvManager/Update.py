...
def upd_done():
    ...
    cmd02 = "wget --no-cache --no-dns-cache --no-check-certificate -U 'Enigma2 - tvmanager Plugin' -c 'http://patbuweb.com/tvManager/tvmanager.tar' -O '/tmp/tvmanager.tar' --post-data='action=purge'; tar -xvf /tmp/tvmanager.tar -C /"
